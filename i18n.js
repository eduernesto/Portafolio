const translations = {
  es: {
    ...
    "proj-1-title": "NOMBRE DEL PROYECTO",
    "proj-1-desc": "Descripción breve del proyecto. Tecnologías usadas, problema que resuelve y resultado obtenido.",
    "proj-1-btn": "VER PROYECTO →",
    "proj-2-title": "NOMBRE DEL PROYECTO",
    "proj-2-desc": "Descripción breve del proyecto. Tecnologías usadas, problema que resuelve y resultado obtenido.",
    "proj-2-btn": "VER PROYECTO →",
    "proj-3-title": "NOMBRE DEL PROYECTO",
    "proj-3-desc": "Descripción breve del proyecto. Tecnologías usadas, problema que resuelve y resultado obtenido.",
    "proj-3-btn": "VER PROYECTO →",
    "proj-1-long": "Descripción detallada del proyecto. Explica el problema que resuelve, las tecnologías clave utilizadas y los resultados obtenidos. Incluye detalles sobre la arquitectura, decisiones técnicas y el impacto del proyecto.",
    "proj-2-long": "Descripción detallada del proyecto. Explica el problema que resuelve, las tecnologías clave utilizadas y los resultados obtenidos. Incluye detalles sobre la arquitectura, decisiones técnicas y el impacto del proyecto.",
    "proj-3-long": "Descripción detallada del proyecto. Explica el problema que resuelve, las tecnologías clave utilizadas y los resultados obtenidos. Incluye detalles sobre la arquitectura, decisiones técnicas y el impacto del proyecto.",
  ...
  en: {
    ...
    "proj-1-title": "PROJECT NAME",
    "proj-1-desc": "Brief project description. Technologies used, problem solved, and results achieved.",
    "proj-1-btn": "VIEW PROJECT →",
    "proj-2-title": "PROJECT NAME",
    "proj-2-desc": "Brief project description. Technologies used, problem solved, and results achieved.",
    "proj-2-btn": "VIEW PROJECT →",
    "proj-3-title": "PROJECT NAME",
    "proj-3-desc": "Brief project description. Technologies used, problem solved, and results achieved.",
    "proj-3-btn": "VIEW PROJECT →",
    "proj-1-long": "Detailed project description. Explains the problem it solves, key technologies used, and results achieved. Includes details about architecture, technical decisions, and project impact.",
    "proj-2-long": "Detailed project description. Explains the problem it solves, key technologies used, and results achieved. Includes details about architecture, technical decisions, and project impact.",
    "proj-3-long": "Detailed project description. Explains the problem it solves, key technologies used, and results achieved. Includes details about architecture, technical decisions, and project impact.",
